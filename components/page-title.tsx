  ...
  return (
    <section className="pt-5 text-center md:pt-7">
      <motion.h1
        ...
        className="font-display text-[clamp(2.35rem,9.2vw,6rem)] font-medium leading-[0.9] tracking-[-0.02em] text-[var(--foreground)]"
      ...
      <motion.p
        ...
        className="mt-2 text-[clamp(1rem,3.9vw,1.55rem)] font-semibold tracking-[-0.008em] text-[var(--foreground)]"
